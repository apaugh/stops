...
UBUNTU_TRANSLATION_DOMAIN="stops.apaugh"
...
aptest.commands = bash $$PWD/Stops/tests/autopilot/run
aptest.depends  = sub-Stops

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Stops/tests/unit 
unittest.depends  = sub-Stops
